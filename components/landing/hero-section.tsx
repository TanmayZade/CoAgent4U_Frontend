...
const HEADLINE = 'Your Personal Agent That Assists You and Collaborates with Other User\'s Agent'
...
export function HeroSection() {
  ...
  useEffect(() => {
    // Suppress GSAP positioning warnings
    const originalWarn = console.warn
    console.warn = (...args: any[]) => {
      if (typeof args[0] === 'string' && args[0].includes('non-static position')) {
        return
      }
    ...
    <section data-section="hero" className="relative min-h-screen flex flex-col justify-start overflow-hidden pt-32 pb-16">
      ...
      <div ref={containerRef} className="relative mx-auto max-w-7xl px-6 w-full">
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          >
            <span ref={cursorRef} aria-hidden="true" className="inline-block w-[3px] h-[0.85em] bg-foreground align-middle ml-0.5" />
          </h1>
